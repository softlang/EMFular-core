...
export class Conversation extends Referencable<any> {
  ...
  constructor(
    ...
    super();
    this._author = new ReTreeSingleContainer<Author>(this, Conversation.$authorName, false);
    this._conversationPartners = new ReTreeListContainer<ConversationPartner>(this, Conversation.$conversationPartnersName, false);
    this.title = title;
...
export class Author extends LifeLine{
  ...
  constructor() {
    super();
    this._preknowledge = new ReTreeListContainer<Preknowledge>(this, Author.$preknowledgeName, false)
    this._messages = new ReTreeListContainer<Message>(this, Author.$messagesName, false)
  }
...
export class SendMessage extends Message {
  ...
  constructor(
    ...
    this._uses  = new ReLinkListContainer(this, SendMessage.$usesName, false, Information.$isUsedOnName);
  }
...
export class ReceiveMessage extends Message {
  ...
  constructor(
    ...
    super(timing, content, originalContent);
    this._generates = new ReTreeListContainer(this, ReceiveMessage.$generatesName, false, NewInformation.$sourceName);
    this._repeats = new ReLinkListContainer(this, ReceiveMessage.$repeatsName, false, Information.$repeatedByName);
...
> extends Referencable<P> {
  ...
  protected constructor() {
    ...
    this._causes = new ReTreeListContainer<InformationLink>(this, NewInformation.$causesName, false, InformationLink.$sourceName);
    this._targetedBy = new ReLinkListContainer(this, Information.$targetedByName, false, InformationLink.$targetName)
    this._isUsedOn = new ReLinkListContainer(this, 'isUsedOn', false, 'uses');
    this._repeatedBy = new ReLinkListContainer(this, NewInformation.$repeatedByName, false, ReceiveMessage.$repeatsName);
  }
...
export class NewInformation extends Information<ReceiveMessage> {
  ...
  constructor() {
    super();
    this._source = new ReTreeParentContainer(this, NewInformation.$sourceName, false, ReceiveMessage.$generatesName);
  }
...
export class InformationLink extends Referencable<Information> {
  ...
  constructor() {
    super();
    this._source = new ReTreeParentContainer(this, InformationLink.$sourceName, false, NewInformation.$causesName);
